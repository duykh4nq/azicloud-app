...
@Component({
  selector: 'app-info-work-asset',
  templateUrl: './info-work-asset.component.html',
  styleUrls: ['./info-work-asset.component.css'],
  providers: [
    { provide: NgbDateParserFormatter, useClass: CustomDateParserFormatter }
  ],
  encapsulation: ViewEncapsulation.None
})
export class InfoWorkAssetComponent implements OnInit {
