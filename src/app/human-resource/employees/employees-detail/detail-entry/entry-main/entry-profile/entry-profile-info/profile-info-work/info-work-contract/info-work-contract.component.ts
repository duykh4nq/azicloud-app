...
@Component({
  selector: 'app-info-work-contract',
  templateUrl: './info-work-contract.component.html',
  styleUrls: ['./info-work-contract.component.css'],
  providers: [
    { provide: NgbDateParserFormatter, useClass: CustomDateParserFormatter }
  ],
  encapsulation: ViewEncapsulation.None
})
export class InfoWorkContractComponent implements OnInit {
