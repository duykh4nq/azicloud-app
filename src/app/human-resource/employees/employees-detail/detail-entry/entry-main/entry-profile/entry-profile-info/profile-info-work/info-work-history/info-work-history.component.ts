...
@Component({
  selector: 'app-info-work-history',
  templateUrl: './info-work-history.component.html',
  styleUrls: ['./info-work-history.component.css'],
  providers: [
    { provide: NgbDateParserFormatter, useClass: CustomDateParserFormatter }
  ],
  encapsulation: ViewEncapsulation.None
})
export class InfoWorkHistoryComponent implements OnInit {
