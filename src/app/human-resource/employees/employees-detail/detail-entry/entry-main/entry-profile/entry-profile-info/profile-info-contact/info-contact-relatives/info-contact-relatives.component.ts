...
@Component({
  selector: 'app-info-contact-relatives',
  templateUrl: './info-contact-relatives.component.html',
  styleUrls: ['./info-contact-relatives.component.css'],
  providers: [
    { provide: NgbDateParserFormatter, useClass: CustomDateParserFormatter }
  ],
  encapsulation: ViewEncapsulation.None
})
export class InfoContactRelativesComponent implements OnInit {
