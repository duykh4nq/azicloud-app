...
@Component({
  selector: 'app-infomations-basic',
  templateUrl: './infomations-basic.component.html',
  styleUrls: ['./infomations-basic.component.css'],
  providers: [
    { provide: NgbDateParserFormatter, useClass: CustomDateParserFormatter }
  ],
  encapsulation: ViewEncapsulation.None
})
export class InfomationsBasicComponent implements OnInit {
