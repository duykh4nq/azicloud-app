...
GanttChart.prototype.correctPosPredecessorTask = function (predTask, ctask, ctaskObj) {
    ...
    else ctask.EST = newDate; if (ctask.ParentTask) {
...
GanttProject.prototype.createProjectItem = function () {
    ...
    tblProjectItem.style.cssText = "border: solid 1px #db4828;";
...
GanttProject.prototype.createProjectNameItem = function () {
    ...
    divName.style.cssText = "cursor:pointer;color:#333;font-weight:bold;font-size:12px;font-family:Tahoma,Arial;white-space:nowrap;height:15px;z-index:1;position:absolute;left:" + 5 + "px;top:" + this.posY + "px;";
...
GanttTask.prototype.createTaskItem = function () {
    ...
    tblTaskItem.style.cssText = "border: solid 1px #f37331;";
